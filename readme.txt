...
3) Необходимо убедиться, что пользователь бд для Debezium имеет права
   LOGIN, REPLICATION. Также на отслеживаемую таблицу необходимо создать публикацию.
...
ps. Во всей системе есть один неприятный ньюанс. Приведу цитату с хабра:
 ...
 Решением проблемы (с условием, что в отслеживаемой таблице есть хотя бы одна строка)
 является удаление топика, удаление коннектора и повторное его добавление, тогда
